...
# def send_mail_report(title, attach_name="APISmartTestReport.zip", receiver="qa@kaiyuan.net"):
def send_mail_report(title, attach_name="APIZhrsTestReport.zip", receiver="liucaiyu@kaiyuan.net"):
    """
    将测试报告发送到邮件
    :param title: 邮件主题
